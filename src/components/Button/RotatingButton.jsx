  ...
  return (
    <button
      className={`absolute container flex justify-center items-center flex-col bg-white p-2 
        transform transition-all duration-1000 -translate-y-2/4 -translate-x-2/4
        ${isClicked 
          ? 'top-[88%] left-[92%] w-[55px] h-[55px] sm:w-[80px] sm:h-[80px] md:w-[120px] md:h-[120px]' 
          : 'top-2/4 left-2/4 w-[120px] h-[120px] md:w-[200px] md:h-[200px]'}`
      }
      onClick={handleClick}
    >
      <motion.svg
